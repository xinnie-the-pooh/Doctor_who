...
#define FW P1_5 //forward pin
#define BW P2_2 //backward pin
...
uint8_t PS_AutoEnroll(uint32_t PageID)
{
...
//void stepmotor()//fake step motor fuction
//{
//  for(int i=0;i<DE;i++){
...
//  }}
  ...
  void pwmmotor(int func)//pwm motor fuction
{
  switch (func)
{
    default:        goto now;
